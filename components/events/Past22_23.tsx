      ...
      content: (
        <div>
          ...
          <p className="text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Mesa pccoe organized a session in collaboration with T&P cell on “opportunities of core job profiles in Capgemini engineering" under model based systems engineering domain. The session was delivered by Mr. Girish Bora sir and Pierre Andre Vandelle
          </p>
          <div className="grid grid-cols-2 gap-4">
            <Image
              src="/2022-23/Capgemini conference .webp"
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="text-neutral-200 text-xs md:text-sm font-normal mb-8">
            The event was arranged to honor teachers for their guidance and help. Various fun games were also organized for them to enjoy the day
          </p>
          <div className="grid grid-cols-2 gap-4">
            <Image
              src="/2022-23/teachers day.webp"
              alt="hero template"
              width={500}
              height={500}
              className="rounded-lg object-cover h-20 md:h-44 lg:h-60 w-full shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]"
