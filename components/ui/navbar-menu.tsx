  ...
  return (
    <div onMouseEnter={() => setActive && setActive(item)} className="relative ">
      <motion.p
        ...
        className={`cursor-pointer hover:opacity-[0.5] text-white font-semibold ${className}`}
      >
        {item}
      </motion.p>
      {active !== null && (
...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative bg-black shadow-input flex justify-center space-x-4 px-8 py-2 "
    >
      {children}
    </nav>
  );
